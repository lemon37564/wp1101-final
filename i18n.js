...
const rankPageEn = [
  "The ranking is calculated as: your score/(your score + enemy's score)",
  "AI weak",
  "AI medium",
  "AI strong",
];
...
const aboutPageZh = [
  ...
  "纖維材質的棋子",
  "陶瓷材質的棋子",
  "提供儲存棋譜功能，資訊儲存在瀏覽器本身的local storage，在該頁面可。<br>可刪除特定一則遊玩紀錄或清空全部紀錄。<br>能夠在下完棋後慢慢思考與檢討。支援記錄匯出、匯入，避免清除瀏覽器快取時失去所有資料，也可以將資料帶著走。<br>在排行榜上顯示之前玩家對戰不同等級AI的分數紀錄，分數由高到低顯示該玩家的姓名及遊玩日期<br>有針對Edge cases做不少測試，盡量減少bug<br>RWD: 響應在各種設備上，能在電腦，平板，手機上顯示<br>語言國際化: 能切換中英版本",
