var Godot = (function () {
  ...
  return function (Godot) {
    ...
    var asmLibraryArg = {
      ...
      Wc: ___sys_getpid,
      Ic: ___sys_getsockname,
      Fc: ___sys_getsockopt,
      pb: ___sys_ioctl,
      Kc: ___sys_listen,
      fd: ___sys_lstat64,
      ed: ___sys_mkdir,
      ...
      ib: _dlopen,
      hj: _dlsym,
      _i: _emscripten_asm_const_int,
      tb: _emscripten_cancel_main_loop,
      Th: _emscripten_force_exit,
      ...
      bi: _emscripten_glCheckFramebufferStatus,
      ai: _emscripten_glClear,
      ...
      $h: _emscripten_glClearColor,
      _h: _emscripten_glClearDepthf,
      Zh: _emscripten_glClearStencil,
      Vd: _emscripten_glClientWaitSync,
      Yh: _emscripten_glColorMask,
      Xh: _emscripten_glCompileShader,
      Wh: _emscripten_glCompressedTexImage2D,
      lf: _emscripten_glCompressedTexImage3D,
      Vh: _emscripten_glCompressedTexSubImage2D,
      kf: _emscripten_glCompressedTexSubImage3D,
      he: _emscripten_glCopyBufferSubData,
      Uh: _emscripten_glCopyTexImage2D,
      Sh: _emscripten_glCopyTexSubImage2D,
      mf: _emscripten_glCopyTexSubImage3D,
      ...
      tf: _emscripten_glDrawElementsInstancedEXT,
      uf: _emscripten_glDrawElementsInstancedNV,
      pf: _emscripten_glDrawRangeElements,
      Ah: _emscripten_glEnable,
      zh: _emscripten_glEnableVertexAttribArray,
      ...
      nf: _emscripten_glTexSubImage3D,
      ...
      Gf: _emscripten_glVertexAttrib2f,
      Ff: _emscripten_glVertexAttrib2fv,
      Ef: _emscripten_glVertexAttrib3f,
      Df: _emscripten_glVertexAttrib3fv,
      Cf: _emscripten_glVertexAttrib4f,
      Bf: _emscripten_glVertexAttrib4fv,
      Dd: _emscripten_glVertexAttribDivisor,
      si: _emscripten_glVertexAttribDivisorANGLE,
      xf: _emscripten_glVertexAttribDivisorARB,
      yf: _emscripten_glVertexAttribDivisorEXT,
      ...
      Af: _emscripten_glVertexAttribPointer,
      zf: _emscripten_glViewport,
      ...
      $b: _emscripten_webgl_destroy_context,
      ...
      nh: _godot_js_config_locale_get,
      Yb: _godot_js_display_alert,
      we: _godot_js_display_canvas_focus,
      He: _godot_js_display_canvas_is_focused,
      ud: _godot_js_display_clipboard_get,
      Fd: _godot_js_display_clipboard_set,
      bf: _godot_js_display_cursor_is_hidden,
      Se: _godot_js_display_cursor_is_locked,
      Ya: _godot_js_display_cursor_lock_set,
      rb: _godot_js_display_cursor_set_custom_shape,
      Rf: _godot_js_display_cursor_set_shape,
      Za: _godot_js_display_cursor_set_visible,
      Ig: _godot_js_display_desired_size_set,
      mc: _godot_js_display_fullscreen_cb,
      ag: _godot_js_display_fullscreen_exit,
      mg: _godot_js_display_fullscreen_request,
      lb: _godot_js_display_has_webgl,
      cd: _godot_js_display_is_swap_ok_cancel,
      jc: _godot_js_display_notification_cb,
      bc: _godot_js_display_pixel_ratio_get,
      cc: _godot_js_display_screen_dpi_get,
      Tg: _godot_js_display_screen_size_get,
      kd: _godot_js_display_setup_canvas,
      ch: _godot_js_display_size_update,
      le: _godot_js_display_touchscreen_is_available,
      hc: _godot_js_display_vk_available,
      ic: _godot_js_display_vk_cb,
      fc: _godot_js_display_vk_hide,
      gc: _godot_js_display_vk_show,
      lc: _godot_js_display_window_blur_cb,
      Wb: _godot_js_display_window_icon_set,
      xg: _godot_js_display_window_size_get,
      Xb: _godot_js_display_window_title_set,
      Ji: _godot_js_eval,
      pj: _godot_js_fetch_body_length_get,
      Hj: _godot_js_fetch_create,
      Ob: _godot_js_fetch_free,
      fj: _godot_js_fetch_http_status_get,
      yj: _godot_js_fetch_is_chunked,
      ij: _godot_js_fetch_read_chunk,
      ej: _godot_js_fetch_read_headers,
      fb: _godot_js_fetch_state_get,
      nc: _godot_js_input_drop_files_cb,
      pc: _godot_js_input_gamepad_cb,
      dc: _godot_js_input_gamepad_sample,
      $d: _godot_js_input_gamepad_sample_count,
      Qd: _godot_js_input_gamepad_sample_get,
      qc: _godot_js_input_key_cb,
      uc: _godot_js_input_mouse_button_cb,
      tc: _godot_js_input_mouse_move_cb,
      sc: _godot_js_input_mouse_wheel_cb,
      oc: _godot_js_input_paste_cb,
      rc: _godot_js_input_touch_cb,
      yi: _godot_js_os_download_buffer,
      _b: _godot_js_os_execute,
      yh: _godot_js_os_finish_async,
      Rb: _godot_js_os_fs_is_persistent,
      ec: _godot_js_os_fs_sync,
      Zb: _godot_js_os_hw_concurrency_get,
      Ub: _godot_js_os_request_quit_cb,
      Vb: _godot_js_os_shell_open,
      Pb: _godot_js_rtc_datachannel_close,
      Sj: _godot_js_rtc_datachannel_connect,
      Pj: _godot_js_rtc_datachannel_destroy,
      Tj: _godot_js_rtc_datachannel_get_buffered_amount,
      Xj: _godot_js_rtc_datachannel_id_get,
      Uj: _godot_js_rtc_datachannel_is_negotiated,
      Yj: _godot_js_rtc_datachannel_is_ordered,
      ...
      Qj: _godot_js_rtc_datachannel_protocol_get,
      _j: _godot_js_rtc_datachannel_ready_state_get,
      Zj: _godot_js_rtc_datachannel_send,
      Oj: _godot_js_rtc_pc_close,
      Jj: _godot_js_rtc_pc_create,
      Ij: _godot_js_rtc_pc_datachannel_create,
      Nb: _godot_js_rtc_pc_destroy,
      Kj: _godot_js_rtc_pc_ice_candidate_add,
      Mj: _godot_js_rtc_pc_local_description_set,
      Nj: _godot_js_rtc_pc_offer_create,
      Lj: _godot_js_rtc_pc_remote_description_set,
      Mb: _godot_js_websocket_buffered_amount,
      Fj: _godot_js_websocket_close,
      Ej: _godot_js_websocket_create,
      Lb: _godot_js_websocket_destroy,
      Gj: _godot_js_websocket_send,
      Si: _godot_js_wrapper_create_cb,
      Ni: _godot_js_wrapper_create_object,
      Ri: _godot_js_wrapper_interface_get,
      Vi: _godot_js_wrapper_object_call,
      aj: _godot_js_wrapper_object_get,
      Fb: _godot_js_wrapper_object_getvar,
      dj: _godot_js_wrapper_object_set,
      Yi: _godot_js_wrapper_object_setvar,
      ni: _godot_js_wrapper_object_unref,
      rj: _godot_webxr_commit_for_eye,
      Bj: _godot_webxr_get_bounds_geometry,
      mj: _godot_webxr_get_controller_axes,
      nj: _godot_webxr_get_controller_buttons,
      qj: _godot_webxr_get_controller_count,
      oj: _godot_webxr_get_controller_transform,
      sj: _godot_webxr_get_external_texture_for_eye,
      tj: _godot_webxr_get_projection_for_eye,
      vj: _godot_webxr_get_render_targetsize,
      uj: _godot_webxr_get_transform_for_eye,
      Aj: _godot_webxr_get_view_count,
      Cj: _godot_webxr_get_visibility_state,
      xj: _godot_webxr_initialize,
      Jb: _godot_webxr_is_controller_connected,
      Dj: _godot_webxr_is_session_supported,
      zj: _godot_webxr_is_supported,
    ...
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["ek"]).apply(
        null,
        arguments
      );
    });
    ...
    var _main = (Module["_main"] = function () {
      return (_main = Module["_main"] = Module["asm"]["gk"]).apply(
        null,
        arguments
      );
    });
    var _malloc = (Module["_malloc"] = function () {
      return (_malloc = Module["_malloc"] = Module["asm"]["hk"]).apply(
        null,
        arguments
      );
    });
    var _htonl = (Module["_htonl"] = function () {
      return (_htonl = Module["_htonl"] = Module["asm"]["ik"]).apply(
        null,
        arguments
      );
    });
    var _htons = (Module["_htons"] = function () {
      return (_htons = Module["_htons"] = Module["asm"]["jk"]).apply(
        null,
        arguments
      );
    });
    var _ntohs = (Module["_ntohs"] = function () {
      return (_ntohs = Module["_ntohs"] = Module["asm"]["kk"]).apply(
        null,
        arguments
      );
    });
    ...
    var _fflush = (Module["_fflush"] = function () {
      return (_fflush = Module["_fflush"] = Module["asm"]["ok"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackSave = (Module["stackSave"] = function () {
      return (stackSave = Module["stackSave"] = Module["asm"]["sk"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackAlloc = (Module["stackAlloc"] = function () {
      return (stackAlloc = Module["stackAlloc"] = Module["asm"]["uk"]).apply(
        null,
        arguments
      );
    });
    var _setThrew = (Module["_setThrew"] = function () {
      return (_setThrew = Module["_setThrew"] = Module["asm"]["vk"]).apply(
        null,
        arguments
      );
    });
    var dynCall_iij = (Module["dynCall_iij"] = function () {
      return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["xk"]).apply(
        null,
        arguments
      );
    });
